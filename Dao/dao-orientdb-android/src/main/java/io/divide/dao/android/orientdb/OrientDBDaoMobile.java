package io.divide.dao.android.orientdb;
 ...
 */
public class OrientDBDaoMobile<T1 extends TransientObject,T2 extends TransientObject> implements DAO<T1,T2> {

    public static final String DEFAULT_CONFIG = "memory:default";

    ODatabaseDocument db;

    public OrientDBDaoMobile(){
    ...
    public OrientDBDaoMobile(ODatabaseDocument db){
        this.db = db;
    }
    ...
    @Override
    public Collection<TransientObject> get(String objectType, String... keys) throws DAO.DAOException {
